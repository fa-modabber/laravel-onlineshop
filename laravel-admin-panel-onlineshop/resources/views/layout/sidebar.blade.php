            ...
            <li class="nav-item dropdown-center">
                ...
                <ul class="dropdown-menu sidebar-menu">
                    ...
                    {{ request()->is('sliders*') ? 'active' : '' }}
                        "
                            href="{{ route('sliders.index') }}">اسلایدر صفحه اصلی</a>
                    </li>
                    <li>
                        <a class="dropdown-item
                    {{ request()->is('features*') ? 'active' : '' }}
                        "
                            href="{{ route('features.index') }}">بخش ویژگی ها</a>
                    </li>
                    <li>
                        <a class="dropdown-item
                        {{ request()->is('about-us*') ? 'active' : '' }}
                        "
                            href="{{ route('about-us.index') }}">بخش درباره ما</a>
                    </li>
                    <li>
                        <a class="dropdown-item
                         {{ request()->is('footer*') ? 'active' : '' }}
                        "
                            href="{{ route('footer.index') }}">بخش فوتر</a>
                    </li>
                </ul>
            </li>
